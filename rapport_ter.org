...
La table [[refnofilter]] indique les scores MAP de la méthode de référence sur les éditions 2016 et 2017 de SemEval.
...
#+NAME: bestof2017
#+CAPTION: Meilleurs scores MAP - SemEval 2017
| Méthode             | Scores MAP |
|---------------------+------------|
